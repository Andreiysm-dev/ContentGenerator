    ...
    return (
        <main className="flex-1 bg-gray-50/50 p-2.5 md:p-6 min-h-0 relative flex flex-col overflow-hidden">
            ...
            <section className="w-full bg-white border border-slate-200/60 rounded-2xl shadow-sm overflow-hidden flex flex-col h-full relative z-10">
                {/* Header */}
                <header className="px-8 py-4 bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 border-b border-slate-700 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 relative overflow-hidden flex-shrink-0">
