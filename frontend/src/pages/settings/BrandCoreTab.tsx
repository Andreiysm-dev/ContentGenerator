        ...
        <div className="rounded-2xl border border-slate-200/70 bg-gradient-to-b from-white/90 to-[#eef4fa]/95 p-4 sm:p-5 shadow-[0_10px_22px_rgba(11,38,65,0.08)]">
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        className={`btn font-bold btn-sm ${isAiAssistantOpen ? 'bg-slate-800 text-white' : 'bg-blue-600 text-white hover:bg-blue-700'}`}
                        type="button"
                        onClick={() => setIsAiAssistantOpen(!isAiAssistantOpen)}
                    >
                        {isAiAssistantOpen ? <><ArrowLeft className="w-4 h-4 mr-2" /> Back to Rules</> : <><Sparkles className="w-4 h-4 mr-2" /> AI Brand Assistant</>}
                    </button>
                ...
                <div className="space-y-6">
                    {isAiAssistantOpen ? (
                        <div className="animate-in fade-in slide-in-from-top-4 duration-300">
                            <BrandAIChat
                                brandKB={brandKbId}
                                onUpdateBrandKB={() => loadBrandKB(false, true)}
                                notify={notify}
