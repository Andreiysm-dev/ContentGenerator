                        ...
                        <div className="rounded-2xl border border-slate-200/70 bg-white p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
                                ...
                                <button
                                    ...
                                    className="group relative flex flex-col items-start rounded-xl border-2 border-[#3fa9f5] bg-blue-50/30 p-5 text-left transition hover:bg-blue-50/50"
                                >
                                    <div className="text-sm font-extrabold text-slate-900">Quick Setup (Recommended)</div>
                                    <div className="mt-1 text-xs text-slate-500">5–7 minutes · Best for agencies & multi-brand managers</div>
                                    <div className="mt-2 text-sm font-medium text-slate-700">Safe defaults + smart inference</div>
                                    <div className="mt-auto pt-4 text-xs font-bold text-[#3fa9f5] group-hover:underline">Start Quick Setup</div>
                                </button>
